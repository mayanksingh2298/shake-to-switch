	...
	try:
		...
		if target_name == 'evince':
			...
			if signal_input == PAUSE:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key space && xdotool windowminimize " + window_id)
			elif signal_input == BACKWARD:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key shift+Right && xdotool windowminimize " + window_id)
			elif signal_input == FORWARD:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key shift+Left && xdotool windowminimize " + window_id)
			elif signal_input == PREVIOUS:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key p && xdotool windowminimize " + window_id)
			elif signal_input == NEXT:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key n && xdotool windowminimize " + window_id)

		elif target_name == 'chrome' or target_name == 'firefox':
			if signal_input == PAUSE:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key k && xdotool windowminimize " + window_id)
			elif signal_input == FORWARD or signal_input == NEXT:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key l && xdotool windowminimize " + window_id)
			elif signal_input == BACKWARD or signal_input == PREVIOUS:
				os.popen(
					"xdotool windowactivate " + window_id + " && sleep 0.01 && xdotool key j && xdotool windowminimize " + window_id)
	except:
		pass
